...
bool CheckStakeKernelHash(const CBlockIndex *pindexPrev, unsigned int nBits, unsigned int nTxPrevOffset, uint256 hashBlockFrom, int64_t blockFromTime, const CTransactionRef& txPrev,
