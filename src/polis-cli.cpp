...
<<<<<<< HEAD:src/polis-cli.cpp
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("polis Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  polis-cli [options] <command> [params]  " + _("Send command to polis Core") + "\n" +
