...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_30_MIN_FEE_BYTES,                 100000000), // OFF
    MAKE_SPORK_DEF(SPORK_31_MIN_FEE_ENFORCE,               1611156456), // 1611156456
    MAKE_SPORK_DEF(SPORK_32_STOP_BLOCKCHAIN_TIMESTAMP,     4070908800ULL), // OFF
};
