...
std::map<int, int64_t> mapSporkDefaults = {
    ...
    {SPORK_15_PEER_DISCONNECT_OLD_PROTOCOL,  4070908800ULL}, // OFF
...
int CSporkManager::GetSporkIDByName(const std::string& strName)
{
    ...
    if (strName == "SPORK_15_PEER_DISCONNECT_OLD_PROTOCOL")     return SPORK_15_PEER_DISCONNECT_OLD_PROTOCOL;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_15_PEER_DISCONNECT_OLD_PROTOCOL:     return "SPORK_15_PEER_DISCONNECT_OLD_PROTOCOL";
